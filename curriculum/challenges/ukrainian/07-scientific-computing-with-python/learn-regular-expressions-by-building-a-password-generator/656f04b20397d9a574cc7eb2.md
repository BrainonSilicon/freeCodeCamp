...
Ви можете отримати той самий результат, не використовуючи функцію `compile()`. Modify your `pattern` variable into the literal string `'l+'`. Потім змініть виклик `print()`, щоб надрукувати `re.search(pattern, quote)`.
